document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
        ...
        const participantsList = details.participants
          .map(participant => `
            <li class="participant-item">
              ...
              <span class="delete-participant" title="Remove participant" data-email="${participant}" data-activity="${name}">&#128465;</span>
            </li>
          `)
          .join("");
      ...
      // Remove activity selection filtering so all cards are shown
      });
    } catch (error) {
